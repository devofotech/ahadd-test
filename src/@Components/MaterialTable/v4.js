        ...
        >
          {columns.map((column, colIndex) => (
            <TableCell
              ...
              colSpan={column.colSpan}
            >
              {/[a-zA-Z0-9\s]/.test(row[column.selector])
                ? (
                  <div style={{ overflow: 'hidden', textOverflow: 'ellipsis', width: column.minWidth }}>
                    <p className="text-dark">{row[column.selector]}</p>
                  </div>
                )
                : (
                  <div style={{ display: 'flex', flexWrap: 'wrap', width: column.minWidth }}>
                    <p className="text-dark">{row[column.selector]}</p>
                  </div>
                )}
      ...
      <TableRow style={{ height: '45rem' }}>
        ...
        >
          <div className="d-flex justify-content-center">
            <img src={NoData} style={{ width: '30vw', pointerEvents: 'none' }} />
          </div>
        </TableCell>
      </TableRow>
    );
