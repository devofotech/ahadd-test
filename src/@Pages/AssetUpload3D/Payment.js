    ...
    <div className="w-100 mx-auto" style={{ minHeight: '60vh' }}>
      ...
      <div className="d-flex justify-content-between mb-4">
        <div>
          ...
          <p className="text-dark">{total_mb.toLocaleString()} mb of 3D File</p>
        </div>
        {!h.isOrgUnlimited && (
          <div className="text-right">
            <p className="color-tertiary">Unit Price / Mb<ArrowDropDownIcon /></p>
      ...
      {!!(!h.intents && !noNeedPay) && (
        <>
          ...
          <Payment
            ...
            items={`[${selectedOutput.label}] 3D Process Files`}
