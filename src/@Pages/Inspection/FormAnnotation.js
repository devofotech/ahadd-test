...
const useStyles = makeStyles(() => ({
  ...
  outlineSelect: {
    width: '100%', padding: 5, fontSize: '10px', border: '1px solid rgba(0, 0, 0, 0.12)', borderRadius: '5px', marginBottom: 10,
  },
  ...
  return (
    <Paper variant="outlined" className={classes.annotationPaperOutline} style={{ ...(selectedStyle.actbg) }}>
      ...
      <div style={{ padding: 10 }}>
        ...
        />
        {!!(props.inspection_module.settings?.includes('severity') && !props.annotation.is_compliance) && (
          <>
