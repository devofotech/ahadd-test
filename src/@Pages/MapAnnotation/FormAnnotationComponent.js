...
export const CustomRadioSeverity = ({ name, items, ...props }) => {
  ...
  return (
    <RadioGroup name={name} row value={props.props.annotation?.SeverityId ?? items[0]?.id} onChange={props.FAh.handleChangeSeverity} className="d-flex justify-content-around">
