    ...
    <Grid item xs={props.isEdit ? 4 : 3}>
      ...
      >
        ...
        <Box className="mx-3">
          ...
          {
            !!props.originalSeverity ? (props.originalSeverity.map((m, idx) => (
              <Typography
            ...
            ))) : (props.defaultSeverityGroup.map((m, idx) => (
              <Typography
                className="mt-2 mx-1 text-capitalize"
                variant="body2"
                color="textSecondary"
            ...
            <>
              {hasAccess && (
                ...
                >
                  ...
                  >
                    {!props.selectedAssetType ? 'Edit Severity' : 'Return to Previous Page'}
                  </Button>
                </Box>
              )}
            </>
